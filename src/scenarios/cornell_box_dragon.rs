...
pub fn cornell_box_dragon_scene(width: usize, height: usize) -> Scene {
    ...
    world.add(TransformedMesh::new(Vec3::new(283.0, 114.0, 268.0), Vec3::new(0.0, -60.0, 0.0), 425.0, dragon).into());

    let bvh = BVH::new(&mut world.objects, 0.0, 1.0);

    let light_shape = Plane::new(Axis::XZ, Bounds2D::new(213.0..343.0, 227.0..332.0), 554.0, white_id);

    Scene::new(String::from("Cornell Box with Dragon"), bvh, materials, camera, vec![Light::new(light_shape.into(), Vec3::new(25.0, 25.0, 25.0))], None, false)
}