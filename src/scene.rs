...
pub fn cornell_box_scene(width: usize, height: usize) -> (String, Camera, Scene, Option<Plane>) {
    ...
    world.add(Geometry::TransformedMesh(Box::new(TransformedMesh::new(Vec3::new(130.0, 0.0, 65.0), Vec3::new(0.0, -18.0, 0.0), 1.0, Rectangle::new(p0, p1, white_id).into()))));
    world.add(Geometry::TransformedMesh(Box::new(TransformedMesh::new(Vec3::new(265.0, 0.0, 295.0), Vec3::new(0.0, 15.0, 0.0), 1.0, Rectangle::new(p0, p2, white_id).into()))));
...
pub fn spheres_in_box_scene(width: usize, height: usize) -> (String, Camera, Scene, Option<Plane>) {
    ...
    world.add(Geometry::ReverseOrientation(Box::new(Plane::new(Axis::XZ, 123.0, 423.0, 147.0, 412.0, 554.0, big_light).into())));
    ...
    let topo_idx = mat!(materials, Diffuse::new(ImageTexture::new("docs/images/world_topo_nasa.jpg", 1.0).into(), 0.0));
    ...
    let marble = mat!(materials, Diffuse::new(ImageTexture::new("docs/images/marble.jpg", 2.0).into(), 0.0));
