...
fn simple_light_scene() -> BVH {
    ...
    world.add(Rectangle::new(rectangle::Plane::XY,
                             3.0,
                             5.0,
                             1.0,
                             3.0,
...
fn cornell_box_scene() -> BVH {
    ...
    world.add(FlipNormals::of(Rectangle::new(rectangle::Plane::YZ,
                                             0.0,
                                             555.0,
                                             0.0,
                                             555.0,
    ...
    world.add(FlipNormals::of(Rectangle::new(rectangle::Plane::XZ,
                                             0.0,
                                             555.0,
                                             0.0,
                                             555.0,
    ...
    world.add(FlipNormals::of(Rectangle::new(rectangle::Plane::XY,
                                             0.0,
                                             555.0,
                                             0.0,
                                             555.0,
