...
![Random Spheres on Ground](docs/renders/random_spheres.png)
![Spheres in a Box with Fog](docs/renders/spheres_in_box.png)
![Cornell Box](docs/renders/cornell_box_objects.png)
![Veach MIS Scene](docs/renders/veach_mis.png)
